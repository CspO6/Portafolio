...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      Swal.close();
      Toast.fire({ icon: "error", title: "No se pudo enviar. Inténtalo de nuevo." });
    } finally {
      ...
      <Container>
        <Row className="align-items-center gy-5">
          ...
          <Col xs={12} md={6} className="order-2 order-md-1">
            <TrackVisibility>
              {({ isVisible }) => (
                <figure className={`contact-ill ${isVisible ? "animate__animated animate__fadeInLeft" : ""}`}>
                  <img src={contactArt} alt="Ilustración de contacto: mensajes y envío" />
                </figure>
              )}
            </TrackVisibility>
          </Col>
          ...
          <Col xs={12} md={6} className="order-1 order-md-2">
            <TrackVisibility>
              {({ isVisible }) => (
                <div className={`contact-card ${isVisible ? "animate__animated animate__fadeInUp" : ""}`}>
                  ...
                  <form onSubmit={handleSubmit} noValidate>
                    <Row className="g-3">
                      ...
                      <Col xs={12} sm={6}>
                        <input
                          type="tel" name="phone" placeholder="No. Teléfono"
                      ...
                      <Col xs={12}>
                        <textarea
                          rows="6" name="message" placeholder="Mensaje"
                      ...
                      <Col xs={12}>
                        <button className="btn-gradient" type="submit" disabled={buttonText !== "Enviar"}>
